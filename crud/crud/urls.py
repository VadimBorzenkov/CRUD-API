...
from todo.views import IndexView, delete_record, EditRecordView, AddRecordView, SearchView
...
urlpatterns = [
    ...
    path('edit_record/<int:pk>/',
         EditRecordView.as_view(template_name='todo/edit_record.html'), name='edit_record'),
